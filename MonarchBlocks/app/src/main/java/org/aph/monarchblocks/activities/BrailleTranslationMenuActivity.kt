...
class BrailleTranslationMenuActivity: AbstractMenuActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(org.aph.monarchblocks.R.string.main_menu)
    }
     ...
     */
    override fun getTitleId() = org.aph.monarchblocks.R.string.main_menu
    ...
    private fun inflateSettingItemLayout(): AccessibleListView {
        return findViewById<AccessibleListView>(R.id.settings_listview).apply {
            ...
            setNext(makeAccessibleItem(org.aph.monarchblocks.R.string.self_brailling_samples))
            setNext(makeAccessibleItem(org.aph.monarchblocks.R.string.layout_samples))
            setNext(makeAccessibleItem(org.aph.monarchblocks.R.string.braille_translation_sample))
